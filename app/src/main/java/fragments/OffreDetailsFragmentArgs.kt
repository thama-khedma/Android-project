...
public data class OffreDetailsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): OffreDetailsFragmentArgs {
      bundle.setClassLoader(OffreDetailsFragmentArgs::class.java.classLoader)
      ...
      return OffreDetailsFragmentArgs(__restaurantId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
            OffreDetailsFragmentArgs {
      val __restaurantId : String?
